...
def trainmodel():
    ...
    print('model_kmeans:',model_kmeans)
    print()
    '''
...
# 模型效果指标评估
def models():
    global  inertias,adjusted_rand_s,mutual_info_s,adjusted_mutual_info_s,homogeneity_s,completeness_s,\
